...
## Overview
Greywatch, also called **the Beacon**, is the only substantial town in [[the-mirrowen|the Mirrowen]] (the Tangles), sitting on a patch of relatively cleared, stable land at the region's northern edge. It is reached from the north via the Drake's Road down from [[drake-mount|Drake Mount]] in [[trevaryn|Trevaryn]], and connects south/west to **Mooncross** in Kalredor. The party arrives here on 28 Dusklin 1568, having chosen [[greywatch]] over the other Furnace Brood leads, to find [[soren-dragan]]'s contact (see [[the-korrathian-conspiracy]]).

It is more a **fortified garrison town** than a civilian one — most people there are present for a purpose rather than simply living. Its walls are massively substantial for a town its size, manned and maintained (unlike the decorative old walls of [[bridgemarch]]), and **heavily warded**: the wards create a pocket of stability so the land immediately around Greywatch does not shift like the rest of the Mirrowen. The gates are watched and arrivals are formally recorded. The walls are an irregular shape because they were originally built to enclose a **dragon landing-ground** (now filled in with houses) — a relic of [[trevaryn|Trevaryn]]'s old closeness to the dragons.
...
- The festival **Shadows Meet** ("the Vigil"), 1 Ithar's Veil, draws pilgrims; masks are worn (see [[itharis]]). The contact's identity and the "rumour" Soren Dragan was sent to chase remain unknown.
